...
export default function MainCampusDashboard() {
  const router = useRouter();

  // Mock metadata for the Physical Main Campus layout
  const stats = {
    totalRooms: 124,
    activeNodes: 342,
    interconnectedLinks: 712,
    lastSync: "2026-05-27 15:40 PHT",
  };
    ...
    <div className="min-h-screen bg-[#f6f8fb] p-8 text-[#111827]">
      ...
      <div className="flex justify-between items-center mb-8 border-b border-gray-200 pb-6">
        <div>
          ...
          <h1 className="text-4xl font-bold mt-2 text-[#111827]">Main Campus Workspace</h1>
          <p className="text-gray-500 text-sm mt-1">Operational configuration, network nodes, and spatial maps for the physical campus quadrants.</p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-[#eceff4] shadow-sm p-6">
        <h3 className="text-sm font-bold text-gray-800 mb-4 flex items-center gap-2">
          ...
          <span>Local Path-Finding Logs (Main Campus Layout)</span>
        </h3>
        <div className="space-y-3 font-mono text-xs text-gray-600">
          <div className="p-3 bg-gray-50 rounded-xl border border-gray-100 flex justify-between">
            <span>[INFO] Ground map matrix topology loaded for multi-story corridors.</span>
            <span className="text-gray-400">4 mins ago</span>
          </div>
          <div className="p-3 bg-gray-50 rounded-xl border border-gray-100 flex justify-between">
            <span>[SUCCESS] Verified 342 active OCR image placard alignment targets.</span>
            <span className="text-gray-400">2 hours ago</span>
          </div>
          <div className="p-3 bg-gray-50 rounded-xl border border-gray-100 flex justify-between">
            <span>[SYSTEM] Re-indexed relational databases links to structural node clusters.</span>
